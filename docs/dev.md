# System Design: ChatSession–Run–Agent–MCPServer–MCPTool–KnowledgeBase
...
<graphml xmlns="http://graphml.graphdrawing.org/xmlns" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://graphml.graphdrawing.org/xmlns http://graphml.graphdrawing.org/xmlns/1.0/graphml.xsd">
  ...
  <graph id="NexusDesign" edgedefault="directed">
    ...
    <node id="ChatMessage"><data key="d0">ChatMessage</data><data key="d1">id,session_id,run_id,role,content.type,content,presentational,tool_call_id,token_count,is_hidden,created_at</data></node>
